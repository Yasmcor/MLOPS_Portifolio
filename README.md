...
| Categoria | Ferramentas | Foco MLOps |
| :--- | :--- | :--- |
| **Linguagem** | Python | Reprodutibilidade e Padrões de Engenharia. |
| **Modelagem** | Scikit-learn (Regressão Logística) | Interpretabilidade e Performance (F1-Score). |
| **Versionamento** | Git, **MLflow** | Rastreamento de experimentos e Governança de modelos. |
| **Deployment** | **FastAPI**, **Docker** | Alta performance e Contêinerização (Portabilidade). |
| **Frontend PoC** | **FlutterFlow App** | Prova de Conceito (PoC) e TTV (Time to Value). |
